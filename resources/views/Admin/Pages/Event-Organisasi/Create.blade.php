        ...
        <div class="row g-0">
            ...
            <div class="col-md-7">
                <div class="card-header pb-0 text-center bg-transparent">
                    <h3 class="font-weight-bolder text-info text-gradient">Form Dokumentasi Kegiatan Organisasi</h3>
                    <p class="mb-0">Lengkapilah Form Berikut Ini Secara Lengkap</p>
                </div>
                <div class="card-body">
                    <form action="{{ url('/admin/event-organisasi/create') }}" method="POST"
                        ...
                        <div class="mb-3">
                            <select class="form-control" id="organisasi_id" name="organisasi_id">
                                ...
                                <option value="{{ $data->id }}"
                                    {{ old('organisasi_id') == $data->id ? 'selected' : '' }}>
                                    {{ $data->organisasi }}
                                </option>
                                @endforeach
                            </select>
