...
<div class="col-12 mt-4">
    <div class="card mb-4">
        <div class="card-header pb-0 p-3">
            <h6 class="mb-1">Daftar Event Organisasi</h6>
            <p class="text-sm">Smk Bhakti Praja Margasari</p>
        </div>
        <div class="card-body p-3">
            <div class="row">
                @foreach ( $events_organisasi as $data )
                    ...
                    <div class="card card-blog card-plain">
                        <div class="position-relative">
                            <div class="d-block shadow-xl border-radius-xl">
                                ...
                                <form action="/admin/event-organisasi/list-organisasi/delete/{{ $data->id }}"
                                    method="POST" class="position-absolute top-0 end-0 mt-2 me-2">
                                    @method('delete')
                                    @csrf
