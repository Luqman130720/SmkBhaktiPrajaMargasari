    ...
    <div class="row gx-4">
        ...
        <div class="col-lg-5 col-md-7 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
            <div class="nav-wrapper position-relative end-5 text-end">
                <a class="btn bg-gradient-dark mb-0" href="{{ url('/admin/event-organisasi/create') }}"><i
                        class="fas fa-plus"></i>&nbsp;&nbsp;Tambahkan Event Organisasi</a>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="card-body p-3">
            <div class="row">
                ...
                <div class="col-xl-3 col-md-6 mb-xl-0 mb-4">
                    <a href="{{ url('/admin/event-organisasi/list-event/' .$data->id) }}">
