    ...
    <div class="row gx-4">
        ...
        <div class="col-lg-5 col-md-7 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
            <div class="nav-wrapper position-relative end-5 text-end">
                <a class="btn bg-gradient-dark mb-0" href="{{ url('/admin/fasilitas/create') }}"><i
                        class="fas fa-plus"></i>&nbsp;&nbsp;Tambahkan Fasilitas Sekolah</a>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="col-xl-3 col-md-6 mb-xl-0 mb-4">
                    <div class="card card-blog card-plain">
                        <div class="position-relative">
                            ...
                            <form action="/admin/fasilitas/delete/{{ $data->id }}" method="POST">
                                @method('delete')
                                @csrf
