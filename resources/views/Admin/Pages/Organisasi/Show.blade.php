    ...
    <div class="row gx-4">
        ...
        <div class="col-lg-5 col-md-7 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
            <div class="nav-wrapper position-relative end-5 text-end">
                <a class="btn bg-gradient-dark mb-0" href="{{ url('/admin/organisasi/create') }}"><i
                        class="fas fa-plus"></i>&nbsp;&nbsp;Tambahkan Organisasi</a>
            </div>
        </div>
    </div>
</div>
                    ...
                    <div class="card card-blog card-plain">
                        ...
                        <div class="card-body px-1 pb-0">
                            ...
                            <div class="col d-flex justify-content-center gap-2">
                                <form action="/admin/organisasi/delete/{{ $data->id }}" method="POST" class="flex-fill">
                                    @method('delete')
                                    @csrf
                                ...
                                <a href="/admin/organisasi/edit/{{ $data->id }}" class="flex-fill">
