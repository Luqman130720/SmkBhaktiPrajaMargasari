    ...
    <div class="row gx-4">
        ...
        <div class="col-lg-5 col-md-7 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
            <div class="nav-wrapper position-relative end-5 text-end">
                <a class="btn bg-gradient-dark mb-0" href="{{ url('/admin/program-studi/create') }}"><i
                        class="fas fa-plus"></i>&nbsp;&nbsp;Tambahkan Program Studi</a>
            </div>
        </div>
    </div>
</div>
...
<div class="col-12 mt-4">
    <div class="card mb-4">
        <div class="card-header pb-0 p-3">
            <h6 class="mb-1">Daftar Prodi / Jurusan</h6>
                ...
                <div class="col-xl-3 col-md-6 mb-xl-0 mb-4">
                    <div class="card card-blog card-plain">
                        ...
                        <div class="card-body px-1 pb-0">
                            <p class="text-gradient text-dark mb-2 text-sm">{{ $data->prodi }}</p>
                            <a href="javascript:;">
                                <h5>
                                    {{ $data->kepanjangan_prodi }}
                                </h5>
                            </a>


                            <div class="col d-flex justify-content-center gap-2">
                                <form action="/admin/program-studi/delete/{{ $data->id }}" method="POST" class="flex-fill">
                                    @method('delete')
                                    @csrf
                                ...
                                <a href="/admin/program-studi/edit/{{ $data->id }}" class="flex-fill">
