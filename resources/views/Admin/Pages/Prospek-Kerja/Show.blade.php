    ...
    <div class="row gx-4">
        ...
        <div class="col-lg-5 col-md-7 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
            <div class="nav-wrapper position-relative end-5 text-end">
                <a class="btn bg-gradient-dark mb-0" href="{{ url('/admin/prospek-kerja/create') }}"><i
                        class="fas fa-plus"></i>&nbsp;&nbsp;Tambahkan Prospek Kerja</a>
            </div>
        </div>
    </div>
</div>
...
<div class="col-12 mt-4">
    <div class="card mb-4">
        <div class="card-header pb-0 p-3">
            <h6 class="mb-1">Prospek Kerja</h6>
            <p class="text-sm">Smk Bhakti Praja Margasari</p>
        </div>
        <div class="card-body p-3">
            <div class="row">
                @foreach ($prospekkerja as $data)
                <div class="col-xl-3 col-md-6 mb-xl-0 mb-4">
                    <div class="card card-blog card-plain">
                        <div class="position-relative">
                            ...
                            <form action="/admin/prospek-kerja/delete/{{ $data->id }}" method="POST">
                                @method('delete')
                                @csrf
